...
/**
 ...
 @return This instance of the settings object.
 */
- (id<CheckSettingsProtocol>)ignoreDisplacements;

/**
 Defines if movement of entire parts of the page should be handled.
 @param ignoreDisplacements Whether or not to handle movement of entire parts of the page.
 @return This instance of the settings object.
 */
- (id<CheckSettingsProtocol>)ignoreDisplacements:(BOOL)ignoreDisplacements;

- (id<CheckSettingsProtocol>)enablePatterns;

- (id<CheckSettingsProtocol>)enablePatterns:(BOOL)enablePatterns;
